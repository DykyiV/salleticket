  ...
  return (
    <SectionPlaceholder
      ...
      features={[
        ...
        {
          text: "9.2 Звіт для перевізника: усі пасажири перевізника з усього сайту; галочка «розбити по агентах» — хто на яку суму бронював і яка його комісія.",
          done: true,
          href: "/admin/reports/carrier",
        },
        {
