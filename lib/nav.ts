...
export type NavItem = {
  href: string;
  label: string;
  icon: "cabinet" | "tickets" | "departures" | "routes" | "settings" | "reports" | "stats";
  minRole: Role;
};

export const CABINET_NAV: NavItem[] = [
  { href: "/cabinet", label: "Мій кабінет", icon: "cabinet", minRole: "USER" },
  { href: "/cabinet/tickets", label: "Квитки", icon: "tickets", minRole: "USER" },
